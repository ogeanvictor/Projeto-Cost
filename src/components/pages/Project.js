...
function Project() {
    ...
    function createService(project) {
        ...
        const newCosts = parseFloat(project.cost) + parseFloat(lastServiceCosts)
                    ...
                    <Container customClass="start" >
                        {services.length > 0 && (
                            services.map((service) => (
                                <ServiceCard id={service.id} name={service.name} costs={service.costs} description={service.cost} key={service.id} handleRemove={removeService} />
                            ))
                        )} 
